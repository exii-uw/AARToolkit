...
namespace HoloToolkit.Unity.SpatialMapping
{
    ...
    public class SurfaceMeshesToPlanes : Singleton<SurfaceMeshesToPlanes>
    {
        ...
        private IEnumerator MakePlanesRoutine()
        {
            ...
            List<MeshFilter> filters = new List<MeshFilter>(); // TODO: Replace SpatialMappingManager.Instance.GetMeshFilters();
            ...
            for (int index = 0; index < planes.Length; index++)
            {
                ...
                else
                {
                    ...
                    //destinationPlane.layer =  // TODO: Reeplace SpatialMappingManager.Instance.PhysicsLayer;
